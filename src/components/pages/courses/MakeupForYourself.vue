                ...
                program: [
                    {
                        list: [
                            ...
                            '6.Как сделать дневной макияж.\n',
                            '7.Как выбрать акцент для вечернего макияжа.\n',
                            '8.Какие продукты для вечернего макияжа глаз необходимы.\n',
                            '9.Кремовые и жидкие текстуры в макияже глаз.\n',
                            '10.Работа с сухими тенями. Какая палетка необходима именно Вам.\n',
                            '11.Как незаметно увеличить губы и исправить асимметрию.'
                        ]
                    },
                ]
            }
